...
Wing.b = 168*IN      # wing span 
Wing.S = 25.66*FT**2  # wing surface area
...
Wing.Aileron.Fc = (5.5/22.0) # chord length of the aileron, % of total chord
Wing.Aileron.Fb = (27.0/84.0) #Span of the aileron, (in long/in wingspan)
...
Wing.Aileron.Servo.Torque = 90*IN*OZM
...
if __name__ == '__main__':
    ...
    Wing.WriteAVLWing('ATLASWing.avl')
