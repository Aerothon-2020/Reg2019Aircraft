...
atlasDir = os.path.join(trunkDir,r'Aircraft_Models\Reg2017Aircraft_BearcatAirlines_v1\ATLAS')

# link path to Aerothon
sys.path.append(trunkDir)

# import Aerothon modules
from scalar.units import LBF, SEC, ARCDEG, FT, IN, SLUG, OZF, OZM, PSI, KG, M, gacc
