...
from Aerodynamics.Wing.wing_carter_builder_winglet import Wing # wing model 
...
# Rudder properties
VTail.Rudder.Fc = 0.54 # percent of vertical tail used by rudder
...
MainGear.GearHeight   = 6.45 * IN
##MainGear.StrutL       = 13.5 * IN # with theta = 0 set to distance axle sits below payload bay
