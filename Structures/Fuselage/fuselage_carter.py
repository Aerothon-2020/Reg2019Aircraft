...
Fuselage.AddSection('PayBay',38.8*IN,1)
Fuselage.AddSection('PayBayGap',0.01*IN,0)
#Fuselage.AddSection('Pay2Tail',42.375*IN,0)
Fuselage.AddSection('Tail',40.875*IN,0)
...
Fuselage.Nose.BackBulk.Width = 13.05*IN
Fuselage.Nose.BackBulk.Height = 6*IN
...
Fuselage.PayBay.FrontBulk.Height = 6.625*IN
Fuselage.PayBay.FrontBulk.Material = AircraftPly.copy()
Fuselage.PayBay.FrontBulk.Material.AreaForceDensity = (0.05*BaseWeight)/(13.05*IN*6.625*IN)
...
Fuselage.PayBay.BackBulk.Height = 6.625*IN #Help
...
Fuselage.PayBay.AddComponent    ("TennisBalls"      , 0.0*LBF, (38.8*IN,13.05*IN,2.5*IN)     , "Front"   , (0.5 , 0.5, 0.88) )
...
Fuselage.PayBayGap.FrontBulk.Height = 6*IN
Fuselage.PayBayGap.FrontBulk.Material = AircraftPly.copy()
Fuselage.PayBayGap.FrontBulk.Material.AreaForceDensity = (1.08*BaseWeight)/(7.75*IN*7.75*IN)
Fuselage.PayBayGap.FrontBulk.WeightGroup = 'Fuselage'

Fuselage.PayBayGap.BackBulk.Width = 2.5*IN
Fuselage.PayBayGap.BackBulk.Height = 2.5*IN
Fuselage.PayBayGap.BackBulk.Material = AircraftPly.copy()
Fuselage.PayBayGap.BackBulk.Material.AreaForceDensity = (1.5*BaseWeight)/(7.5*IN*3.0*IN)
Fuselage.PayBayGap.BackBulk.WeightGroup = 'Fuselage'

Fuselage.PayBayGap.Align = 1.0 

# front bulkhead definition(matches the nose cross-sectional dimension)
#Fuselage.Pay2Tail.FrontBulk.Width = 2.5*IN
#Fuselage.Pay2Tail.FrontBulk.Height = 2.5*IN
...
# rear bulkhead definition (matches the cross-sectional dimension of the nose and payload bay together)
#Fuselage.Pay2Tail.BackBulk.Width = 2.5*IN
#Fuselage.Pay2Tail.BackBulk.Height = 2.5*IN
...
Fuselage.Payload.Position = (0.30,0.5,0.55) # changed ACFuselage (ACPayload class)
