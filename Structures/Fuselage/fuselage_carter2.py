...
Fuselage.Nose.FrontBulk.Width = 8.377*IN
Fuselage.Nose.FrontBulk.Height = 2.35*IN
Fuselage.Nose.FrontBulk.Material = AircraftPly.copy()
Fuselage.Nose.FrontBulk.Material.AreaForceDensity = (0.01*BaseWeight)/(8.377*IN*2.35*IN)
Fuselage.Nose.FrontBulk.WeightGroup = 'Fuselage'

# rear bulkhead definition
Fuselage.Nose.BackBulk.Width = 8.377*IN
Fuselage.Nose.BackBulk.Height = 4.5*IN
Fuselage.Nose.BackBulk.Material = AircraftPly.copy()
Fuselage.Nose.BackBulk.Material.AreaForceDensity = (0.03*BaseWeight)/(8.377*IN*4.5*IN)
...
# SECTION 2: Nose to Payload bay section ----------------------------------------------#
...
Fuselage.NoseToPayBay.FrontBulk.Width = 8.377*IN
Fuselage.NoseToPayBay.FrontBulk.Height = 4.5*IN
Fuselage.NoseToPayBay.FrontBulk.Material = AircraftPly.copy()
Fuselage.NoseToPayBay.FrontBulk.Material.AreaForceDensity = (0.05*BaseWeight)/(8.377*IN*4.5*IN)
Fuselage.NoseToPayBay.FrontBulk.WeightGroup = 'Fuselage'

# rear bulkhead definition (matches the cross-sectional dimension of the nose and payload bay together)
Fuselage.NoseToPayBay.BackBulk.Width = 13.05*IN
Fuselage.NoseToPayBay.BackBulk.Height = 4.775*IN #Help
Fuselage.NoseToPayBay.BackBulk.Material = AircraftPly.copy()
Fuselage.NoseToPayBay.BackBulk.Material.AreaForceDensity = (0.1*BaseWeight)/(13.05*IN*4.775*IN)
Fuselage.NoseToPayBay.BackBulk.WeightGroup = 'Fuselage'

# miscellaneous
Fuselage.NoseToPayBay.SkinMat = Ultracote.copy()
Fuselage.NoseToPayBay.WeightGroup = 'Fuselage'
Fuselage.NoseToPayBay.StringerMat = AircraftPly.copy()
Fuselage.NoseToPayBay.StringerMat.LinearForceDensity = 0.01*LBF/IN
Fuselage.NoseToPayBay.Align = 1 # Top of section relative to previous section


# SECTION 3: Payload bay section ----------------------------------------------#

# SPH 12/1/2015: target weight from 151130 CAD @ 8.8oz and CG @ 6.48125
# in SolidWorks relative to payload CG (0.55,0.00,-0.99)

# front bulkhead definition(matches the nose cross-sectional dimension)
Fuselage.PayBay.FrontBulk.Width = 13.05*IN
Fuselage.PayBay.FrontBulk.Height = 4.775*IN
Fuselage.PayBay.FrontBulk.Material = AircraftPly.copy()
Fuselage.PayBay.FrontBulk.Material.AreaForceDensity = (0.05*BaseWeight)/(13.05*IN*4.775*IN)
Fuselage.PayBay.FrontBulk.WeightGroup = 'Fuselage'

# rear bulkhead definition (matches the cross-sectional dimension of the nose and payload bay together)
Fuselage.PayBay.BackBulk.Width = 13.05*IN
Fuselage.PayBay.BackBulk.Height = 4.775*IN #Help
Fuselage.PayBay.BackBulk.Material = AircraftPly.copy()
Fuselage.PayBay.BackBulk.Material.AreaForceDensity = (0.1*BaseWeight)/(13.05*IN*4.775*IN)
...
Fuselage.PayBay.AddComponent    ("TennisBalls"      , 0.0*LBF, (26*IN,13.05*IN,2.5*IN)     , "Front"   , (0.5 , 0.5, 0.75) )
Fuselage.PayBay.TennisBalls.WeightGroup = "Fuselage"

Fuselage.PayBay.AddComponent    ("Ballast"  , 4*LBF, (0.1*IN, 0.1*IN, 0.1*IN)   , "Front" , (0, 0, 0))
Fuselage.PayBay.Ballast.WeightGroup = "Fuselage"


# SECTION 4: Payload bay Gap -------------------------------------#


# SPH 12/1/2015: target weight from 151130 CAD @ 1.12oz and CG @ 13.19125
# in SolidWorks relative to payload CG (-6.16,0,-1.73)
Fuselage.PayBayGap.FrontBulk.Width = 13.05*IN
Fuselage.PayBayGap.FrontBulk.Height = 4.775*IN
Fuselage.PayBayGap.FrontBulk.Material = AircraftPly.copy()
Fuselage.PayBayGap.FrontBulk.Material.AreaForceDensity = (1.08*BaseWeight)/(13.05*IN*4.775*IN)
Fuselage.PayBayGap.FrontBulk.WeightGroup = 'Fuselage'

Fuselage.PayBayGap.BackBulk.Width = 8.377*IN
Fuselage.PayBayGap.BackBulk.Height = 4.5*IN
Fuselage.PayBayGap.BackBulk.Material = AircraftPly.copy()
Fuselage.PayBayGap.BackBulk.Material.AreaForceDensity = (1.5*BaseWeight)/(8.377*IN*4.5*IN)
Fuselage.PayBayGap.BackBulk.WeightGroup = 'Fuselage'

Fuselage.PayBayGap.Align = 1.0 

# front bulkhead definition(matches the nose cross-sectional dimension)
Fuselage.Pay2Tail.FrontBulk.Width = 8.377*IN
Fuselage.Pay2Tail.FrontBulk.Height = 4.5*IN
Fuselage.Pay2Tail.FrontBulk.Material = AircraftPly.copy()
Fuselage.Pay2Tail.FrontBulk.Material.AreaForceDensity = (1.08*BaseWeight)/(8.377*IN*4.5*IN)
Fuselage.Pay2Tail.FrontBulk.WeightGroup = 'Fuselage'

# rear bulkhead definition (matches the cross-sectional dimension of the nose and payload bay together)
Fuselage.Pay2Tail.BackBulk.Width = 8.377*IN
Fuselage.Pay2Tail.BackBulk.Height = 4.5*IN
Fuselage.Pay2Tail.BackBulk.Material = AircraftPly.copy()
Fuselage.Pay2Tail.BackBulk.Material.AreaForceDensity = (1.5*BaseWeight)/(8.377*IN*4.5*IN)
...
# front bulkhead definition(matches the nose cross-sectional dimension)
Fuselage.Pay2TailGap.FrontBulk.Width = 8.377*IN
Fuselage.Pay2TailGap.FrontBulk.Height = 4.5*IN
Fuselage.Pay2TailGap.FrontBulk.Material = AircraftPly.copy()
Fuselage.Pay2TailGap.FrontBulk.Material.AreaForceDensity = (1.08*BaseWeight)/(8.377*IN*4.5*IN)
Fuselage.Pay2TailGap.FrontBulk.WeightGroup = 'Fuselage'

# rear bulkhead definition (matches the cross-sectional dimension of the nose and payload bay together)
Fuselage.Pay2TailGap.BackBulk.Width = 3*IN
Fuselage.Pay2TailGap.BackBulk.Height = 3*IN
Fuselage.Pay2TailGap.BackBulk.Material = AircraftPly.copy()
Fuselage.Pay2TailGap.BackBulk.Material.AreaForceDensity = (1.5*BaseWeight)/(3*IN*3*IN)
Fuselage.Pay2TailGap.BackBulk.WeightGroup = 'Fuselage'

# miscellaneous
Fuselage.Pay2TailGap.SkinMat = Ultracote.copy()
Fuselage.Pay2TailGap.WeightGroup = 'Fuselage'
Fuselage.Pay2TailGap.StringerMat = AircraftPly.copy()
Fuselage.Pay2TailGap.StringerMat.LinearForceDensity = 0.0058*LBF/IN
Fuselage.Pay2TailGap.Align = 1.0 # Top of section relative to previous seciton
...
# front bulkhead definition(matches the nose cross-sectional dimension)
Fuselage.Tail.FrontBulk.Width = 3*IN
Fuselage.Tail.FrontBulk.Height = 3.0*IN
Fuselage.Tail.FrontBulk.Material = AircraftPly.copy()
Fuselage.Tail.FrontBulk.Material.AreaForceDensity = (0.15*BaseWeight)/(3*IN*3.0*IN)
Fuselage.Tail.FrontBulk.WeightGroup = 'Fuselage'

# rear bulkhead definition (matches the cross-sectional dimension of the nose and payload bay together)
Fuselage.Tail.BackBulk.Width = 3*IN
Fuselage.Tail.BackBulk.Height = 3.0*IN
Fuselage.Tail.BackBulk.Material = AircraftPly.copy()
Fuselage.Tail.BackBulk.Material.AreaForceDensity = (0.15*BaseWeight)/(3*IN*3.0*IN)
...
Fuselage.Payload.Width  = 12*IN  #changed ACFuselage pretty significantly
Fuselage.Payload.Length = 0.72*IN #changed ACFuselage pretty significantly
Fuselage.Payload.Material = Steel.copy()
Fuselage.Payload.Weight = 0.0*LBF
Fuselage.Payload.Position = (9/26.567,0.5,0.1) # changed ACFuselage (ACPayload class)
